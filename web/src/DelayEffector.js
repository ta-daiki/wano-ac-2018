...
/*
Code generated with Faust version 2.13.11
Compilation options: wasm, -scal -ftz 2
*/

function getJSONDelayEffector() {
	return "{\"name\":\"DelayEffector\",\"filename\":\"DelayEffector\",\"version\":\"2.13.11\",\"compile_options\":\"-scal -ftz 2\",\"library_list\":[\"/usr/local/share/faust/stdfaust.lib\",\"/usr/local/share/faust/maths.lib\"],\"include_pathnames\":[\"/usr/local/share/faust\",\"/usr/local/share/faust\",\"/usr/share/faust\",\".\",\"/home/aogiri/repository/wano-ac-2018/faustSrc\"],\"size\":\"2097240\",\"inputs\":\"2\",\"outputs\":\"2\",\"meta\":[{\"filename\":\"DelayEffector\"},{\"maths.lib/author\":\"GRAME\"},{\"maths.lib/copyright\":\"GRAME\"},{\"maths.lib/license\":\"LGPL with exception\"},{\"maths.lib/name\":\"Faust Math Library\"},{\"maths.lib/version\":\"2.1\"},{\"name\":\"DelayEffector\"}],\"ui\":[{\"type\":\"vgroup\",\"label\":\"DelayEffector\",\"items\":[{\"type\":\"hgroup\",\"label\":\"Delay\",\"items\":[{\"type\":\"hslider\",\"label\":\"Delay Feedback\",\"address\":\"/DelayEffector/Delay/Delay_Feedback\",\"index\":\"20\",\"meta\":[{\"style\":\"knob\"}],\"init\":\"0.5\",\"min\":\"0\",\"max\":\"1\",\"step\":\"0.01\"},{\"type\":\"hslider\",\"label\":\"Delay Time (msec)\",\"address\":\"/DelayEffector/Delay/Delay_Time_(msec)\",\"index\":\"16\",\"meta\":[{\"style\":\"knob\"}],\"init\":\"100\",\"min\":\"1\",\"max\":\"1000\",\"step\":\"1\"},{\"type\":\"hslider\",\"label\":\"Wet\",\"address\":\"/DelayEffector/Delay/Wet\",\"index\":\"0\",\"meta\":[{\"style\":\"knob\"}],\"init\":\"0.5\",\"min\":\"0\",\"max\":\"1\",\"step\":\"0.01\"}]},{\"type\":\"hgroup\",\"label\":\"SubEffector\",\"items\":[{\"type\":\"hslider\",\"label\":\"Cutoff Frequency (Hz)\",\"address\":\"/DelayEffector/SubEffector/Cutoff_Frequency_(Hz)\",\"index\":\"28\",\"meta\":[{\"style\":\"knob\"}],\"init\":\"5000\",\"min\":\"40\",\"max\":\"15000\",\"step\":\"1\"},{\"type\":\"hslider\",\"label\":\"Drive\",\"address\":\"/DelayEffector/SubEffector/Drive\",\"index\":\"32\",\"meta\":[{\"style\":\"knob\"}],\"init\":\"5\",\"min\":\"1\",\"max\":\"20\",\"step\":\"0.01\"}]}]}]}";
}
/*
 faust2webaudio
...
*/
faust.DelayEffector = function (dsp_instance, context, buffer_size) {
    ...
    try {
        json_object = JSON.parse(getJSONDelayEffector());
    } catch (e) {
...
*/
faust.createDelayEffector = function(context, buffer_size, callback)
{
    var importObject = {
        env: {
            memoryBase: 0,
    ...
    fetch('DelayEffector.wasm')
    .then(dsp_file => dsp_file.arrayBuffer())
    .then(dsp_bytes => WebAssembly.instantiate(dsp_bytes, importObject))
    .then(dsp_module => callback(faust.DelayEffector(dsp_module.instance, context, buffer_size)))
    .catch(function(error) { console.log(error); faust.error_msg = "Faust DelayEffector cannot be loaded or compiled"; callback(null); });
}
